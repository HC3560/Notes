...
HD_PWD='D:/Xilinx/Projects/class_blink/class_blink.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log src.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source src.tcl
